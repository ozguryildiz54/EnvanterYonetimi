...
function validateForm2() {        
    ...
    var cihazModeliId = document.forms["ArizaBildirimi"]["cihazModeliId"].value;
    var garantiBas = document.forms["ArizaBildirimi"]["garantiBas"].value;
    var envNo = document.forms["ArizaBildirimi"]["envNo"].value;
    var seriNo = document.forms["ArizaBildirimi"]["seriNo"].value;
    var durum = document.forms["ArizaBildirimi"]["durum"].value;
    var aciklama = document.forms["ArizaBildirimi"]["aciklama"].value;
...
//    //var chkSelect = document.getElementById('durum');

//    //chkSelect.disabled = true;        // Control Enable here
//    var txtCommision = document.getElementById('durum');
//    txtCommision.disabled = !this.checked;
//}
//function EnableDisableTextBox() {
//    var status = document.getElementById('durum').checked;
//    if (status == false) {
...
//    //var status = document.getElementById('durum').checked;
//    //if (status == true) {
//    //    document.getElementById('durum').readOnly = false;
//    //} else {
//    //    document.getElementById('durum').readOnly = true;
//    //}
//    document.getElementById('durum').removeAttribute('readonly');
...
function EnableDisableTextBox() {
    var txt = document.getElementById('durum');
    ...
    //txt.readOnly = "readonly";
    //        document.getElementById('durum').readOnly = true;
    //document.getElementById("durum").setAttribute("readonly", true);
...
//$(document).on('click', '#buttonsearch55', function () {
//    var txt = document.getElementById('durum');
//    if (txt.readOnly == true)
//        txt.readOnly = false;
//    else
